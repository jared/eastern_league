...
ActiveRecord::Schema.define(:version => 20140522131937) do
  ...
  create_table "annual_events", :force => true do |t|
    t.string   "event_name"
  ...
  create_table "event_registrations", :force => true do |t|
    ...
    t.integer  "number_for_dinner",                                   :default => 0
  end
